  ...
  return (
    <div class="separator__container container-fluid g-0 p-0">
      <p class="separator__text">
        ...
        Tech
        Mono,monospace}.RRSS_link,.footer_Link,.navLink,.text_Link{text-decoration:none}.about_quote,
        .proximamente,.tab_wrap{place-content:center}body{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;font-family:-apple-system,BlinkMacSystemFont,Segoe
          UI,Roboto,Oxygen,Ubuntu,Cantarell,Fira Sans,Droid Sans,Helvetica
          Neue,sans-serif;margin:0}code{font-family:source-code-pro,Menlo,Monaco,Consolas,Courier
            New,monospace}.App{overflow-x:hidden;text-align:center}::-webkit-scrollbar{height:8px;width:8px}::-webkit-
              `}
      </p>
    </div>
  );
